export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      importTokensTitle: 'Import GPT Tokens',
      importTokensHint: 'Paste or upload one token per line (Access Token or Refresh Token). The system auto-detects the type and batch-creates OpenAI accounts.',
      importTokensPaste: 'Paste Text',
      importTokensFile: 'Upload File',
      importTokensInput: 'Token List',
      importTokensPlaceholder: 'One token per line. Supports mixed Access Tokens (eyJ...) and Refresh Tokens.',
      importTokensFileLabel: 'Token File',
      importTokensSelectFile: 'Please select a file',
      importTokensNamePrefix: 'Account Name Prefix',
      importTokensNamePrefixPlaceholder: 'e.g. GPT',
      importTokensButton: 'Start Import',
      importTokensImporting: 'Importing...',
      importTokensProgress: 'Processing {current}/{total}',
      importTokensResult: 'Import Result',
      importTokensResultSummary: 'Total {total}, succeeded {success}, failed {failed}',
      importTokensErrors: 'Error Details',
      importTokensSuccess: 'Import completed, {count} accounts created',
      importTokensPartialSuccess: 'Partially succeeded: {success} created, {failed} failed',
      importTokensAllFailed: 'Import failed, no accounts could be created',
      importTokensEmpty: 'No valid tokens detected',
      importTokensParseFailed: 'Failed to read file',
