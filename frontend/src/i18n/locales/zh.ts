export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      importTokens: '导入 Tokens',
      importTokensTitle: '导入 GPT Tokens',
      importTokensHint: '支持每行一个 Access Token 或 Refresh Token，系统自动识别类型并批量创建 OpenAI 账号。',
      importTokensPaste: '粘贴文本',
      importTokensFile: '上传文件',
      importTokensInput: 'Token 列表',
      importTokensPlaceholder: '每行一个 Token，支持 Access Token（eyJ...）和 Refresh Token 混合输入',
      importTokensFileLabel: 'Token 文件',
      importTokensSelectFile: '请选择文件',
      importTokensNamePrefix: '账号名前缀',
      importTokensNamePrefixPlaceholder: '例如 GPT',
      importTokensButton: '开始导入',
      importTokensImporting: '导入中...',
      importTokensProgress: '处理中 {current}/{total}',
      importTokensResult: '导入结果',
      importTokensResultSummary: '共 {total} 条，成功 {success}，失败 {failed}',
      importTokensErrors: '失败详情',
      importTokensSuccess: '导入完成，成功创建 {count} 个账号',
      importTokensPartialSuccess: '部分成功：成功 {success}，失败 {failed}',
      importTokensAllFailed: '导入失败，所有 Token 均未能创建账号',
      importTokensEmpty: '未检测到有效的 Token',
      importTokensParseFailed: '文件读取失败',
